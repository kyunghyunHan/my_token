module my_token::my_nft {
    ...
    fun init_module(resource_acc: &signer) {
        // creates signer from resource account and store MyToken under Resource acc
    ...
    //     assert!(exists<MyToken>(@my_token), 22);
    ...
    //     aptos_std::debug::print<MyToken>(borrow_global<MyToken>(@my_token));
    // }
